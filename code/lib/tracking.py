...
#                 print pt                
#==============================================================================
                print "Image1.Nmls[ 100:103,100:103]"
                print Image1.Nmls[ 100:103,100:103]
...
#==============================================================================
        ...
        res[0:3,0:3] = LA.inv(res[0:3,0:3])
        res[0:3,3] = -np.dot(res[0:3,0:3],res[0:3,3])        
        return res        
